...
const { createLecture, listCourseLectures, listFeaturedLectures, listLecturesForEditing, updateLecture, reorderLectures, deleteLecture } = require('../controllers/lectureController');
